...
# Usage:
#   terrier_list_unique(<list_variable> [<list_variable>] [...])
macro(terrier_list_unique)
  foreach(__lst ${ARGN})
    if(${__lst})
...
# Usage:
#   terrier_clear_vars(<variables_list>)
macro(terrier_clear_vars)
  foreach(_var ${ARGN})
    unset(${_var})
  endforeach()
endmacro()
...
# Usage:
#   terrier_string_unique(<string_variable>)
function(terrier_string_unique __string)
  if(${__string})
    set(__list ${${__string}})
...
# Usage:
#   terrier_print_list(<list>)
function(terrier_print_list)
  foreach(e ${ARGN})
    message(STATUS ${e})
  endforeach()
endfunction()
...
# Usage:
#   terrier_merge_flag_lists(out_variable <list1> [<list2>] [<list3>] ...)
function(terrier_merge_flag_lists out_var)
  set(__result "")
  foreach(__list ${ARGN})
...
# Usage:
#   terrier_convert_absolute_paths(<list_variable>)
function(terrier_convert_absolute_paths variable)
  set(__dlist "")
...
# Usage:
#   terrier_parse_header(<file> <define1> <define2> <define3> ..)
macro(terrier_parse_header FILENAME FILE_VAR)
  set(vars_regex "")
...
# Usage:
#   terrier_parse_header_single_define(<library_name> <file> <define_name>)
function(terrier_parse_header_single_define LIBNAME HDR_PATH VARNAME)
  set(${LIBNAME}_H "")
  if(EXISTS "${HDR_PATH}")
...
# Usage:
#   terrier_option(<option_variable> "doc string" <initial value or boolean expression> [IF <condition>])
function(terrier_option variable description value)
  set(__value ${value})
  set(__condition "")
...
# Usage:
#   terrier_compare_lists(<list_variable> <list2_variable> [description])
function(terrier_compare_lists list1 list2 desc)
  set(__list1 ${${list1}})
  set(__list2 ${${list2}})
  list(SORT __list1)
  list(SORT __list2)
...
# Usage:
#   terrier_warnings_disable(<CMAKE_[C|CXX]_FLAGS[_CONFIGURATION]> -Wshadow /wd4996 ..,)
macro(terrier_warnings_disable)
  set(_flag_vars "")
  set(_msvc_warnings "")
  set(_gxx_warnings "")
  ...
  terrier_clear_vars(_flag_vars _msvc_warnings _gxx_warnings)
endmacro()

################################################################################################
# Helper function get current definitions
# Usage:
#   terrier_get_current_definitions(<definitions_variable>)
function(terrier_get_current_definitions definitions_var)
...
# Usage:
#   terrier_parse_linker_libs(<Terrier_LINKER_LIBS_var> <directories_var> <libflags_var> <frameworks_var>)
function(terrier_parse_linker_libs Terrier_LINKER_LIBS_variable folders_var flags_var frameworks_var)
  ...
  foreach(list_elem ${${Terrier_LINKER_LIBS_variable}})
  ...
  terrier_list_unique(libflags folders)
...
# Usage:
#   terrier_detect_darwin_version(<version_variable>)
function(terrier_detect_darwin_version output_var)
  if(APPLE)
