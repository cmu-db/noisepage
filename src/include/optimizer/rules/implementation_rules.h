...
/**
 * Rule transforms Logical DropFunction -> Physical DropFunction
 */
class LogicalDropFunctionToPhysicalDropFunction : public Rule {
 public:
  /** Constructor */
  LogicalDropFunctionToPhysicalDropFunction();
