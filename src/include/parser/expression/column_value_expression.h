...
class ColumnValueExpression : public AbstractExpression {
 ...
 private:
  ...
  /**
   * Copy constructor for ColumnValueExpression
   * Relies on AbstractExpression copy constructor for base members
   * @param other Other ColumnValueExpression to copy from
   */
  ColumnValueExpression(const ColumnValueExpression &other) = default;
