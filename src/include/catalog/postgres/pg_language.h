...
constexpr language_oid_t INTERNAL_LANGUAGE_OID = language_oid_t(0);
constexpr language_oid_t PLPGSQL_LANGUAGE_OID = language_oid_t(1);
constexpr language_oid_t INITIAL_LANGUAGE_COUNTER_OID = language_oid_t(2);
