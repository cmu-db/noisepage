...
class PgIndex {
 public:
   ...
   */
  static constexpr col_oid_t INDOID_COL_OID = col_oid_t(1);          // INTEGER (pkey, fkey: pg_class)
  static constexpr col_oid_t INDRELID_COL_OID = col_oid_t(2);        // INTEGER (fkey: pg_class)
  static constexpr col_oid_t INDISUNIQUE_COL_OID = col_oid_t(3);     // BOOLEAN
  static constexpr col_oid_t INDISPRIMARY_COL_OID = col_oid_t(4);    // BOOLEAN
  static constexpr col_oid_t INDISEXCLUSION_COL_OID = col_oid_t(5);  // BOOLEAN
  static constexpr col_oid_t INDIMMEDIATE_COL_OID = col_oid_t(6);    // BOOLEAN
  static constexpr col_oid_t INDISVALID_COL_OID = col_oid_t(7);      // BOOLEAN
  static constexpr col_oid_t INDISREADY_COL_OID = col_oid_t(8);      // BOOLEAN
  static constexpr col_oid_t INDISLIVE_COL_OID = col_oid_t(9);       // BOOLEAN
  static constexpr col_oid_t IND_TYPE_COL_OID = col_oid_t(10);       // CHAR (see IndexSchema)
