...
constexpr col_oid_t REL_PTR_COL_OID = col_oid_t(5);         // BIGINT (assumes 64-bit pointers)
constexpr col_oid_t REL_NEXTCOLOID_COL_OID = col_oid_t(6);  // INTEGER
constexpr col_oid_t REL_VERS_COL_OID = col_oid_t(7);        // SMALLINT
...
constexpr std::array<col_oid_t, NUM_PG_CLASS_COLS> PG_CLASS_ALL_COL_OIDS = {
    ...
    REL_PTR_COL_OID, REL_NEXTCOLOID_COL_OID, REL_VERS_COL_OID};
