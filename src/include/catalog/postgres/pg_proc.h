...
constexpr proc_oid_t VERSION_PRO_OID = proc_oid_t(98);
constexpr proc_oid_t ASCII_PRO_OID = proc_oid_t(99);
constexpr proc_oid_t CHR_PRO_OID = proc_oid_t(100);
constexpr proc_oid_t CHARLENGTH_PRO_OID = proc_oid_t(101);
constexpr proc_oid_t POSITION_PRO_OID = proc_oid_t(102);
