...
constexpr proc_oid_t STARTSWITH_PRO_OID = proc_oid_t(103);
constexpr proc_oid_t SUBSTR_PRO_OID = proc_oid_t(104);
constexpr proc_oid_t LEFT_PRO_OID = proc_oid_t(105);
constexpr proc_oid_t RIGHT_PRO_OID = proc_oid_t(106);
constexpr proc_oid_t REVERSE_PRO_OID = proc_oid_t(107);
constexpr proc_oid_t REPEAT_PRO_OID = proc_oid_t(108);
constexpr proc_oid_t TRIM_PRO_OID = proc_oid_t(109);
constexpr proc_oid_t TRIM2_PRO_OID = proc_oid_t(110);
constexpr proc_oid_t ABS_INT_PRO_OID = proc_oid_t(111);
constexpr proc_oid_t ABS_REAL_PRO_OID = proc_oid_t(112);
constexpr proc_oid_t ASCII_PRO_OID = proc_oid_t(113);
...
constexpr proc_oid_t LPAD2_PRO_OID = proc_oid_t(118);
constexpr proc_oid_t LTRIM2ARG_PRO_OID = proc_oid_t(119);
constexpr proc_oid_t LTRIM1ARG_PRO_OID = proc_oid_t(120);
constexpr proc_oid_t RPAD_PRO_OID = proc_oid_t(121);
constexpr proc_oid_t RPAD2_PRO_OID = proc_oid_t(122);
constexpr proc_oid_t RTRIM2ARG_PRO_OID = proc_oid_t(123);
constexpr proc_oid_t RTRIM1ARG_PRO_OID = proc_oid_t(124);
constexpr proc_oid_t VERSION_PRO_OID = proc_oid_t(125);
constexpr proc_oid_t DATE_PART_PRO_OID = proc_oid_t(126);
