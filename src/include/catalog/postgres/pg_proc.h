...
constexpr proc_oid_t CEIL_PRO_OID = proc_oid_t(95);
constexpr proc_oid_t FLOOR_PRO_OID = proc_oid_t(96);
constexpr proc_oid_t TRUNCATE_PRO_OID = proc_oid_t(97);
constexpr proc_oid_t LOG10_PRO_OID = proc_oid_t(98);
constexpr proc_oid_t LOG2_PRO_OID = proc_oid_t(99);
constexpr proc_oid_t LOWER_PRO_OID = proc_oid_t(100);
constexpr proc_oid_t UPPER_PRO_OID = proc_oid_t(101);
constexpr proc_oid_t STARTSWITH_PRO_OID = proc_oid_t(102);
constexpr proc_oid_t SUBSTR_PRO_OID = proc_oid_t(103);
constexpr proc_oid_t LEFT_PRO_OID = proc_oid_t(104);
constexpr proc_oid_t RIGHT_PRO_OID = proc_oid_t(105);
constexpr proc_oid_t REVERSE_PRO_OID = proc_oid_t(106);
constexpr proc_oid_t REPEAT_PRO_OID = proc_oid_t(107);
constexpr proc_oid_t TRIM_PRO_OID = proc_oid_t(108);
constexpr proc_oid_t TRIM2_PRO_OID = proc_oid_t(109);
constexpr proc_oid_t ABS_INT_PRO_OID = proc_oid_t(110);
constexpr proc_oid_t ABS_REAL_PRO_OID = proc_oid_t(111);
constexpr proc_oid_t VERSION_PRO_OID = proc_oid_t(112);
constexpr proc_oid_t DATE_PART_PRO_OID = proc_oid_t(113);
