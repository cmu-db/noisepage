...
constexpr proc_oid_t LOWER_PRO_OID = proc_oid_t(105);
constexpr proc_oid_t UPPER_PRO_OID = proc_oid_t(106);
constexpr proc_oid_t VERSION_PRO_OID = proc_oid_t(107);
constexpr proc_oid_t ASCII_PRO_OID = proc_oid_t(108);
constexpr proc_oid_t CHR_PRO_OID = proc_oid_t(109);
constexpr proc_oid_t CHARLENGTH_PRO_OID = proc_oid_t(110);
constexpr proc_oid_t POSITION_PRO_OID = proc_oid_t(111);
constexpr proc_oid_t LENGTH_PRO_OID = proc_oid_t(112);
