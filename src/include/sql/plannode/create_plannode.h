...
class CreatePlan : public AbstractPlan {
 public:
  ...
  explicit CreatePlan(std::string table_name, std::string schema_name, std::string database_name,
  ...
  std::unique_ptr<AbstractPlan> Copy() const {
    return std::unique_ptr<AbstractPlan>(new CreatePlan(table_name, schema_name, database_name,
 ...
 protected:
  ...
  void ProcessForeignKeyConstraint(const std::string &table_name, const parser::ColumnDefinition *col);
