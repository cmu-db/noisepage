...
class ProjectionPlan : public AbstractPlan {
 public:
  ...
  std::unique_ptr<AbstractPlan> Copy() const override {
    std::shared_ptr<const catalog::Schema> schema_copy(catalog::Schema::CopySchema(schema_.get()));
    ProjectionPlan *new_plan = new ProjectionPlan(project_info_->Copy(), schema_copy);
