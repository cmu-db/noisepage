 ...
 */
  ...
  private:
    ...
    // The checkpoint mechanism directly uses the blocks_ field of the data table to for storage.
    friend class Checkpoint;
    // The recovery mechanism directly adds blocks to the blocks_ list.
    friend class RecoveryManager;
    // The recovery test directly checks the table content using layout and blocks_.
