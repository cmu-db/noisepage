...
VM_OP_HOT void OpIndexIteratorHasNext(bool *has_more,
                                      tpl::sql::IndexIterator *iter) {
  *has_more = iter->HasNext();
}

VM_OP_HOT void OpIndexIteratorAdvance(tpl::sql::IndexIterator *iter) {
  iter->Advance();
}

VM_OP_HOT void OpIndexIteratorGetSmallInt(tpl::sql::Integer *out,
                                          tpl::sql::IndexIterator *iter,
                                          u32 col_idx) {
  // Read
  auto *ptr = iter->Get<i16, false>(col_idx, nullptr);
...
VM_OP_HOT void OpIndexIteratorGetInteger(tpl::sql::Integer *out,
                                         tpl::sql::IndexIterator *iter,
                                         u32 col_idx) {
  // Read
  auto *ptr = iter->Get<i32, false>(col_idx, nullptr);
...
VM_OP_HOT void OpIndexIteratorGetBigInt(tpl::sql::Integer *out,
                                        tpl::sql::IndexIterator *iter,
                                        u32 col_idx) {
  // Read
  auto *ptr = iter->Get<i64, false>(col_idx, nullptr);
...
VM_OP_HOT void OpIndexIteratorGetDecimal(tpl::sql::Decimal *out,
                                         UNUSED tpl::sql::IndexIterator *iter,
                                         UNUSED u32 col_idx) {
  // Set
  out->is_null = false;
  out->val = 0;
...
VM_OP_HOT void OpIndexIteratorGetSmallIntNull(tpl::sql::Integer *out,
                                              tpl::sql::IndexIterator *iter,
                                              u32 col_idx) {
  // Read
  bool null = false;
...
VM_OP_HOT void OpIndexIteratorGetIntegerNull(tpl::sql::Integer *out,
                                             tpl::sql::IndexIterator *iter,
                                             u32 col_idx) {
  // Read
  bool null = false;
...
VM_OP_HOT void OpIndexIteratorGetBigIntNull(tpl::sql::Integer *out,
                                            tpl::sql::IndexIterator *iter,
                                            u32 col_idx) {
  // Read
  bool null = false;
...
VM_OP_HOT void OpIndexIteratorGetDecimalNull(tpl::sql::Decimal *out,
                                             tpl::sql::IndexIterator *iter,
                                             u32 col_idx) {
  out->val = 0;
  out->is_null = false;
