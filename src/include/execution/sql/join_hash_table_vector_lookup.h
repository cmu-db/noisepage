...
class JoinHashTableVectorLookup {
 public:
  ...
  const HashTableEntry *GetNextOutput(VectorProjectionIterator *vpi, KeyEqFn key_eq_fn) noexcept;
...
inline const HashTableEntry *JoinHashTableVectorLookup::GetNextOutput(VectorProjectionIterator *vpi,
