...
class DecimalMagicNumbers {
 public:
  ...
  //            notice if you're about to divide by a specific constant and quickly slide in that value, so there's
  //            value in keeping the maps. The magic numbers are generated by magic_number_generator.py.
