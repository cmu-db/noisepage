...
class StringFunctions {
 public:
   ...
   */
  static void CharLength(exec::ExecutionContext *ctx, Integer *result,
                         const StringVal &str) {
   ...
   */
  static void Left(exec::ExecutionContext *ctx, StringVal *result,
                   const StringVal &str, const Integer &n);

  /**
   * Return the length of the string
   */
  static void Length(exec::ExecutionContext *ctx, Integer *result,
                     const StringVal &str);

  /**
   * Set the string to lower case
   */
  static void Lower(exec::ExecutionContext *ctx, StringVal *result,
                    const StringVal &str);

  /**
   * Pads the left side of the string with min(pad_length, len) characters
   */
  static void Lpad(exec::ExecutionContext *ctx, StringVal *result,
   ...
   */
  static void Ltrim(exec::ExecutionContext *ctx, StringVal *result,
   ...
   */
  static void Repeat(exec::ExecutionContext *ctx, StringVal *result,
                     const StringVal &str, const Integer &n);

  /**
   * Reverse a string
   */
  static void Reverse(exec::ExecutionContext *ctx, StringVal *result,
                      const StringVal &str);

  /**
   * Last min(length, n) characters of the string
   */
  static void Right(exec::ExecutionContext *ctx, StringVal *result,
                    const StringVal &str, const Integer &n);

  /**
   * Pads the right side of the string with min(pad_length, len) characters
   */
  static void Rpad(exec::ExecutionContext *ctx, StringVal *result,
                   const StringVal &str, const Integer &n,
                   const StringVal &pad);
   ...
   */
  static void Rtrim(exec::ExecutionContext *ctx, StringVal *result,
                    const StringVal &str, const StringVal &chars);
   ...
   */
  static void SplitPart(exec::ExecutionContext *ctx, StringVal *result,
   ...
   */
  static void Substring(exec::ExecutionContext *ctx, StringVal *result,
   ...
   */
  static void Trim(exec::ExecutionContext *ctx, StringVal *result,
                   const StringVal &str, const StringVal &chars);
   ...
   */
  static void Upper(exec::ExecutionContext *ctx, StringVal *result,
                    const StringVal &str);
};
