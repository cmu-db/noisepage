...
#define BUILTINS_LIST(F)                                                    \
  ...
  F(IndexIteratorScanAscendingClosed, indexIteratorScanAscendingClosed)     \
  F(IndexIteratorScanAscendingOpenHigh, indexIteratorScanAscendingOpenHigh) \
  F(IndexIteratorScanAscendingOpenLow, indexIteratorScanAscendingOpenLow)   \
  F(IndexIteratorScanAscendingOpenBoth, indexIteratorScanAscendingOpenBoth) \
