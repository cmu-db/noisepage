...
//   */
//  DeleteTranslator(const planner::DeletePlanNode &plan, CompilationContext *compilation_context,
//                   Pipeline *pipeline);
//
//  // Does nothing
...
//  // Delete from index.
//  void GenIndexDelete(FunctionBuilder *builder, const catalog::index_oid_t &index_oid) const;
