...
#define COMPARISON_OP(type) ((type) <= terrier::parser::ExpressionType::COMPARE_IS_DISTINCT_FROM && (type) \
>= terrier::parser::ExpressionType::COMPARE_EQUAL)

#define ARITHMETIC_OP(type) ((type) <= terrier::parser::ExpressionType::OPERATOR_MOD && (type) \
>= terrier::parser::ExpressionType::OPERATOR_PLUS)

#define UNARY_OP(type) ((type) == terrier::parser::ExpressionType::OPERATOR_UNARY_MINUS || \
((type) >= terrier::parser::ExpressionType::OPERATOR_CAST && (type) <= \
terrier::parser::ExpressionType::OPERATOR_EXISTS))

#define CONJUNCTION_OP(type) ((type) <= terrier::parser::ExpressionType::CONJUNCTION_OR && (type) \
>= terrier::parser::ExpressionType::CONJUNCTION_AND)
