...
class CodeGen {
 ...
 public:
   ...
   * @param si_ptr A pointer to the storage interface to initialize.
   * @param exec_ctx The execution context that we are running in.
   ...
   * @return The expression corresponding to the builtin call.
   */
  ast::Expr *StorageInterfaceInit(ast::Expr *si_ptr, ast::Expr *exec_ctx, uint32_t table_oid, ast::Identifier col_oids,
                                  bool need_indexes);
