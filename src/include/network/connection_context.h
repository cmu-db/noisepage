...
class ConnectionContext {
 public:
  ...
  /**
   * @return handle to the ConnectionHandle callback to issue an event wakeup in the event of WAIT_ON_NOISEPAGE
  ...
  /**
   * @return args to the ConnectionHandle callback to issue an event wakeup in the event of WAIT_ON_NOISEPAGE
   * state. Currently not used, but may in the future for asynchronous execution.
   */
 ...
 private:
  ...
  /**
   * ConnectionHandle callback stuff to issue an event wakeup in the event of WAIT_ON_NOISEPAGE state. Currently
