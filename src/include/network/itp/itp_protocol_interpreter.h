...
//     */
//    explicit Provider(common::ManagedPointer<ITPCommandFactory> command_factory)
...
//
//   private:
//    common::ManagedPointer<ITPProtocolInterpreter> command_factory_;
//  };
//
//  /**
//   * Default constructor
//   */
//  explicit PostgresProtocolInterpreter(common::ManagedPointer<ITPCommandFactory> command_factory)
//      : command_factory_(command_factory) {}
//
//  /**
