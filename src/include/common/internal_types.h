...
#define VALUE_COMPARE_NO_EQUAL -3  // assigned when comparing array list and no element matching.
...
enum class TimestampType { INVALID = INVALID_TYPE_ID, SNAPSHOT_READ = 1, READ = 2, COMMIT = 3 };
...
enum class VisibilityType { INVALID = INVALID_TYPE_ID, INVISIBLE = 1, DELETED = 2, OK = 3 };
...
enum class VisibilityIdType { INVALID = INVALID_TYPE_ID, READ_ID = 1, COMMIT_ID = 2 };
...
enum class TriggerType {
  BEFORE_INSERT_ROW = TRIGGER_TYPE_BEFORE | TRIGGER_TYPE_INSERT | TRIGGER_TYPE_ROW,
  BEFORE_INSERT_STATEMENT = TRIGGER_TYPE_BEFORE | TRIGGER_TYPE_INSERT | TRIGGER_TYPE_STATEMENT,
  BEFORE_UPDATE_ROW = TRIGGER_TYPE_BEFORE | TRIGGER_TYPE_UPDATE | TRIGGER_TYPE_ROW,
  BEFORE_UPDATE_STATEMENT = TRIGGER_TYPE_BEFORE | TRIGGER_TYPE_UPDATE | TRIGGER_TYPE_STATEMENT,
  BEFORE_DELETE_ROW = TRIGGER_TYPE_BEFORE | TRIGGER_TYPE_DELETE | TRIGGER_TYPE_ROW,
  BEFORE_DELETE_STATEMENT = TRIGGER_TYPE_BEFORE | TRIGGER_TYPE_DELETE | TRIGGER_TYPE_STATEMENT,
  AFTER_INSERT_ROW = TRIGGER_TYPE_AFTER | TRIGGER_TYPE_INSERT | TRIGGER_TYPE_ROW,
  AFTER_INSERT_STATEMENT = TRIGGER_TYPE_AFTER | TRIGGER_TYPE_INSERT | TRIGGER_TYPE_STATEMENT,
  AFTER_UPDATE_ROW = TRIGGER_TYPE_AFTER | TRIGGER_TYPE_UPDATE | TRIGGER_TYPE_ROW,
  AFTER_UPDATE_STATEMENT = TRIGGER_TYPE_AFTER | TRIGGER_TYPE_UPDATE | TRIGGER_TYPE_STATEMENT,
  AFTER_DELETE_ROW = TRIGGER_TYPE_AFTER | TRIGGER_TYPE_DELETE | TRIGGER_TYPE_ROW,
  AFTER_DELETE_STATEMENT = TRIGGER_TYPE_AFTER | TRIGGER_TYPE_DELETE | TRIGGER_TYPE_STATEMENT,
  ON_COMMIT_INSERT_ROW = TRIGGER_TYPE_COMMIT | TRIGGER_TYPE_INSERT | TRIGGER_TYPE_ROW,
  ON_COMMIT_INSERT_STATEMENT = TRIGGER_TYPE_COMMIT | TRIGGER_TYPE_INSERT | TRIGGER_TYPE_STATEMENT,
  ON_COMMIT_UPDATE_ROW = TRIGGER_TYPE_COMMIT | TRIGGER_TYPE_UPDATE | TRIGGER_TYPE_ROW,
  ON_COMMIT_UPDATE_STATEMENT = TRIGGER_TYPE_COMMIT | TRIGGER_TYPE_UPDATE | TRIGGER_TYPE_STATEMENT,
  ON_COMMIT_DELETE_ROW = TRIGGER_TYPE_COMMIT | TRIGGER_TYPE_DELETE | TRIGGER_TYPE_ROW,
  ON_COMMIT_DELETE_STATEMENT = TRIGGER_TYPE_COMMIT | TRIGGER_TYPE_DELETE | TRIGGER_TYPE_STATEMENT,
};

const int TRIGGER_TYPE_MAX = TRIGGER_TYPE_ROW | TRIGGER_TYPE_STATEMENT | TRIGGER_TYPE_BEFORE | TRIGGER_TYPE_AFTER |
                             TRIGGER_TYPE_COMMIT | TRIGGER_TYPE_INSERT | TRIGGER_TYPE_DELETE | TRIGGER_TYPE_UPDATE;
...
// ItemPointer -> type
typedef tbb::concurrent_unordered_map<ItemPointer, RWType, ItemPointerHasher, ItemPointerComparator> ReadWriteSet;
...
// block -> offset -> type
typedef std::unordered_map<oid_t, std::unordered_map<oid_t, GCVersionType>> GCSet;
...
struct FileHandle {
  ...
  FileHandle(FILE *file, int fd, size_t size) : file(file), fd(fd), size(size) {}
};
...
ConstraintType PostgresConstraintTypeToPelotonConstraintType(PostgresConstraintType type);
...
struct AnnotatedExpression {
  AnnotatedExpression(std::shared_ptr<expression::AbstractExpression> i_expr, std::unordered_set<std::string> &i_set)
...
typedef std::unordered_map<std::string, std::vector<std::shared_ptr<expression::AbstractExpression>>>
    SingleTablePredicatesMap;

// TODO(boweic): use raw ptr
// Mapping of Expression -> Column Offset created by operator
typedef std::unordered_map<expression::AbstractExpression *, unsigned, expression::ExprHasher, expression::ExprEqualCmp>
    ExprMap;
// Used in optimizer to speed up expression comparsion
typedef std::unordered_set<expression::AbstractExpression *, expression::ExprHasher, expression::ExprEqualCmp> ExprSet;
...
typedef Eigen::Matrix<float, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor> matrix_eig;
