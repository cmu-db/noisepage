...
class Exception : public std::runtime_error {
 public:
  Exception(std::string message) : std::runtime_error(message), type(ExceptionType::INVALID) {
    exception_message_ = "Message :: " + message;
  }

  Exception(ExceptionType exception_type, std::string message) : std::runtime_error(message), type(exception_type) {
    exception_message_ = "Exception Type :: " + ExceptionTypeToString(exception_type) + "\nMessage :: " + message;
  }
...
class ValueOutOfRangeException : public Exception {
 ...
 public:
  ValueOutOfRangeException(const int64_t value, const type::TypeId origType, const type::TypeId newType)
  ...
  ValueOutOfRangeException(const double value, const type::TypeId origType, const type::TypeId newType)
      : Exception(ExceptionType::CONVERSION, "Type " + TypeIdToString(origType) + " with value " +
                                                 std::to_string(value) +
                                                 " can't be cast as %s because the value is out of range "
                                                 "for the destination type " +
...
class ConversionException : public Exception {
 ...
 public:
  ConversionException(std::string msg) : Exception(ExceptionType::CONVERSION, msg) {}
};
...
class UnknownTypeException : public Exception {
 ...
 public:
  UnknownTypeException(int type, std::string msg)
      : Exception(ExceptionType::UNKNOWN_TYPE, "unknown type " + std::to_string(type) + msg) {}
};
...
class TypeMismatchException : public Exception {
 ...
 public:
  TypeMismatchException(std::string msg, const type::TypeId type_1, const type::TypeId type_2)
...
class NumericValueOutOfRangeException : public Exception {
 ...
 public:
  ...
  NumericValueOutOfRangeException(std::string msg, int type)
      : Exception(ExceptionType::OUT_OF_RANGE, msg + " " + std::to_string(type)) {}
};
...
class DivideByZeroException : public Exception {
 ...
 public:
  DivideByZeroException(std::string msg) : Exception(ExceptionType::DIVIDE_BY_ZERO, msg) {}
};
...
class ObjectSizeException : public Exception {
 ...
 public:
  ObjectSizeException(std::string msg) : Exception(ExceptionType::OBJECT_SIZE, msg) {}
};
 ...
 public:
  IncompatibleTypeException(int type, std::string msg)
      : Exception(ExceptionType::INCOMPATIBLE_TYPE,
                  "Incompatible type " + TypeIdToString(static_cast<type::TypeId>(type)) + msg) {}
};
...
class SerializationException : public Exception {
 ...
 public:
  SerializationException(std::string msg) : Exception(ExceptionType::SERIALIZATION, msg) {}
};
...
class TransactionException : public Exception {
 ...
 public:
  TransactionException(std::string msg) : Exception(ExceptionType::TRANSACTION, msg) {}
};
...
class NotImplementedException : public Exception {
 ...
 public:
  NotImplementedException(std::string msg) : Exception(ExceptionType::NOT_IMPLEMENTED, msg) {}
};
...
class ExpressionException : public Exception {
 ...
 public:
  ExpressionException(std::string msg) : Exception(ExceptionType::EXPRESSION, msg) {}
};
...
class SchedulerException : public Exception {
 ...
 public:
  SchedulerException(std::string msg) : Exception(ExceptionType::SCHEDULER, msg) {}
};
...
class ExecutorException : public Exception {
 ...
 public:
  ExecutorException(std::string msg) : Exception(ExceptionType::EXECUTOR, msg) {}
};
...
class ConstraintException : public Exception {
 ...
 public:
  ConstraintException(std::string msg) : Exception(ExceptionType::CONSTRAINT, msg) {}
};
...
class ConnectionException : public Exception {
 ...
 public:
  ConnectionException(std::string msg) : Exception(ExceptionType::CONNECTION, msg) {}
};
...
class SettingsException : public Exception {
 ...
 public:
  SettingsException(std::string msg) : Exception(ExceptionType::SETTINGS, msg) {}
};
...
class OptimizerException : public Exception {
 ...
 public:
  OptimizerException(std::string msg) : Exception(ExceptionType::OPTIMIZER, msg) {}
};
...
class NullPointerException : public Exception {
 ...
 public:
  NullPointerException(std::string msg) : Exception(ExceptionType::NULL_POINTER, msg) {}
};
