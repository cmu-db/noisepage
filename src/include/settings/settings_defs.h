...
SETTING_int(port, "Terrier port (default: 15721)", 15721, 1024, 65535, false, MainDatabase::EmptyCallback)  // NOLINT
    ...
    */
    ...
    SETTING_double(bnlj_buffer_size, "The default buffer size to use for blockwise nested loop joins (default: 1 MB)",
                   1.0 * 1024.0 * 1024.0, 1.0 * 1024, 1.0 * 1024.0 * 1024.0 * 1024, true, MainDatabase::EmptyCallback)
    ...
    */
    ...
    SETTING_bool(index_tuner, "Enable index tuner (default: false)", false, true, MainDatabase::EmptyCallback)

    // Enable or disable layout tuner
    SETTING_bool(layout_tuner, "Enable layout tuner (default: false)", false, true, MainDatabase::EmptyCallback)
    ...
    SETTING_bool(brain, "Enable brain (default: false)", false, true, MainDatabase::EmptyCallback)
    ...
    */
    ...
    SETTING_bool(display_settings, "Display settings (default: false)", false, true, MainDatabase::EmptyCallback)
