...
// Terrier port
SETTING_int(port, "Terrier port (default: 15721)", 15721, 1024, 65535, false, terrier::DBMain::EmptyCallback)

// Maximum number of connections
SETTING_int(max_connections, "Maximum number of connections (default: 64)", 64, 1, 512, true, terrier::DBMain::EmptyCallback)
...
// RPC port
SETTING_int(rpc_port, "Terrier rpc port (default: 15445)", 15445, 1024, 65535, false, terrier::DBMain::EmptyCallback)
...
SETTING_bool(rpc_enabled, "Enable rpc, this should be turned off when testing", false, false, terrier::DBMain::EmptyCallback)
...
SETTING_double(bnlj_buffer_size, "The default buffer size to use for blockwise nested loop joins (default: 1 MB)",
               1.0 * 1024.0 * 1024.0, 1.0 * 1024, 1.0 * 1024.0 * 1024.0 * 1024, true, terrier::DBMain::EmptyCallback)
...
SETTING_int(connection_thread_count, "Number of connection threads (default: std::hardware_concurrency())",
            std::thread::hardware_concurrency(), 1, 64, false, terrier::DBMain::EmptyCallback)
...
SETTING_int(min_parallel_table_scan_size,                                                               // NOLINT
            ...
            "(default: 10K)",                                                                           // NOLINT
            10 * 1000, 1, std::numeric_limits<int32_t>::max(), true, terrier::DBMain::EmptyCallback)             // NOLINT
...
SETTING_bool(index_tuner, "Enable index tuner (default: false)", false, true, terrier::DBMain::EmptyCallback)

// Enable or disable layout tuner
SETTING_bool(layout_tuner, "Enable layout tuner (default: false)", false, true, terrier::DBMain::EmptyCallback)
...
SETTING_bool(brain, "Enable brain (default: false)", false, true, terrier::DBMain::EmptyCallback)
...
SETTING_int(brain_task_queue_size, "Brain Task Queue Size (default: 32)", 32, 1, 128, false, terrier::DBMain::EmptyCallback)

// Size of the brain worker pool
SETTING_int(brain_worker_pool_size, "Brain Worker Pool Size (default: 1)", 1, 1, 16, false, terrier::DBMain::EmptyCallback)
...
SETTING_bool(dump_ir, "Enable logging of all generated IR (default: false)", false, true, terrier::DBMain::EmptyCallback)
...
SETTING_int(task_execution_timeout,                             // NOLINT
            ...
            5000, 1000, 60000, true, terrier::DBMain::EmptyCallback)     // NOLINT
// NOLINT
...
SETTING_bool(display_settings, "Display settings (default: false)", false, true, terrier::DBMain::EmptyCallback)

//===----------------------------------------------------------------------===//
// Used only in Tests
//===----------------------------------------------------------------------===//

SETTING_int(fixed_int, "(Test only) A fixed int param", 100, 10, 1000, false, terrier::DBMain::EmptyCallback)

SETTING_bool(fixed_bool, "(Test only) A fixed bool param", false, false, terrier::DBMain::EmptyCallback)

SETTING_double(fixed_double, "(Test only) A fixed double param", 114.514, 100.0, 1000.0, false, terrier::DBMain::EmptyCallback)

SETTING_string(fixed_string, "(Test only) A fixed string param", "You cannot change me", false, terrier::DBMain::EmptyCallback)

// Test int knob
SETTING_int(lucky_number, "(Test only) Your lucky number", 114, 114, 514, true, terrier::DBMain::EmptyCallback)

// Test string knob
SETTING_string(db_name, "(Test only) The name for this database", "Terrier", true, terrier::DBMain::EmptyCallback)

// Test decimal knob
SETTING_double(pi, "(Test only) The value of pi", 3.14159, 3.0, 4.0, true, terrier::DBMain::EmptyCallback)

// Test immutable boolean knob
SETTING_bool(p_eq_np, "(Test only) Whether P=NP", false, true, terrier::DBMain::EmptyCallback)