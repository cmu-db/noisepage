...
// Test string knob
SETTING_string(db_name, "The name for this database", "Terrier", true, terrier::DBMain::EmptyCallback)

// Test decimal knob
SETTING_double(pi, "The value of pi", 3.14159, 3.0, 4.0, true, terrier::DBMain::EmptyCallback)