...
SETTING_int(buffer_pool_size, "Buffer pool size in transaction manager (default : 100000)", 100000, 1, 1000000,
            true, DBMain::BufferPoolSizeCallback)
// RPC port
SETTING_int(rpc_port, "Terrier rpc port (default: 15445)", 15445, 1024, 65535, false, DBMain::EmptyCallback)
...
SETTING_bool(rpc_enabled, "Enable rpc, this should be turned off when testing", false, false, DBMain::EmptyCallback)
...
SETTING_double(bnlj_buffer_size, "The default buffer size to use for blockwise nested loop joins (default: 1 MB)",
               1.0 * 1024.0 * 1024.0, 1.0 * 1024, 1.0 * 1024.0 * 1024.0 * 1024, true, DBMain::EmptyCallback)
...
SETTING_int(connection_thread_count, "Number of connection threads (default: std::hardware_concurrency())",
            std::thread::hardware_concurrency(), 1, 64, false, DBMain::EmptyCallback)
...
SETTING_int(min_parallel_table_scan_size,                                                               // NOLINT
            ...
            "(default: 10K)",                                                                           // NOLINT
            10 * 1000, 1, std::numeric_limits<int32_t>::max(), true, DBMain::EmptyCallback)             // NOLINT
...
SETTING_bool(index_tuner, "Enable index tuner (default: false)", false, true, DBMain::EmptyCallback)

// Enable or disable layout tuner
SETTING_bool(layout_tuner, "Enable layout tuner (default: false)", false, true, DBMain::EmptyCallback)
...
SETTING_bool(brain, "Enable brain (default: false)", false, true, DBMain::EmptyCallback)
...
SETTING_int(brain_task_queue_size, "Brain Task Queue Size (default: 32)", 32, 1, 128, false, DBMain::EmptyCallback)

// Size of the brain worker pool
SETTING_int(brain_worker_pool_size, "Brain Worker Pool Size (default: 1)", 1, 1, 16, false, DBMain::EmptyCallback)
...
SETTING_bool(dump_ir, "Enable logging of all generated IR (default: false)", false, true, DBMain::EmptyCallback)
...
SETTING_int(task_execution_timeout,                             // NOLINT
            ...
            5000, 1000, 60000, true, DBMain::EmptyCallback)     // NOLINT
// NOLINT
...
SETTING_bool(display_settings, "Display settings (default: false)", false, true, DBMain::EmptyCallback)
...
// Test string knob
SETTING_string(db_name, "The name for this database", "Terrier", true, DBMain::EmptyCallback)

// Test decimal knob
SETTING_double(pi, "The value of pi", 3.14159, 3.0, 4.0, true, DBMain::EmptyCallback)