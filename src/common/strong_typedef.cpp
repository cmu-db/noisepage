...
template class StrongTypeAlias<terrier::execution::tags::query_id_t_typedef_tag, uint64_t>;
template class StrongTypeAlias<terrier::execution::tags::pipeline_id_t_typedef_tag, uint64_t>;
