...
bool RecoveryManager::IsCatalogTable(catalog::table_oid_t table_oid) {
  ...
  !table_oid == !catalog::postgres::NAMESPACE_TABLE_OID ||
  !table_oid == !catalog::postgres::CLASS_TABLE_OID ||
  !table_oid == !catalog::postgres::COLUMN_TABLE_OID ||
  !table_oid == !catalog::postgres::CONSTRAINT_TABLE_OID ||
  !table_oid == !catalog::postgres::INDEX_TABLE_OID ||
  !table_oid == !catalog::postgres::TYPE_TABLE_OID ||
  !table_oid == !catalog::postgres::LANGUAGE_TABLE_OID ||
  !table_oid == !catalog::postgres::PRO_TABLE_OID;
}
