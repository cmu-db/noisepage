...
void OptimizeGroup::Execute() {
  OPTIMIZER_LOG_TRACE("OptimizeGroup::Execute() group " + std::to_string(group_->GetID().underlying_value()));
...
void DeriveStats::Execute() {
  ...
  OPTIMIZER_LOG_TRACE("DeriveStats::Execute() group " + std::to_string(gexpr_->GetGroupID().underlying_value()));
