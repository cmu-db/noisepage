...
OperatorTranslator *TranslatorFactory::CreateTranslator(const terrier::planner::AbstractPlanNode &op,
                                                        Pipeline *pipeline) {
...
ExpressionTranslator *TranslatorFactory::CreateTranslator(const terrier::parser::AbstractExpression &expression,
