...
void InPlaceOperation(common::ManagedPointer<exec::ExecutionSettings> exec_settings, Vector *left,
                      const Vector &right) {
...
void VectorOps::AddInPlace(common::ManagedPointer<exec::ExecutionSettings> exec_settings, Vector *left,
                           const Vector &right) {
  // Sanity check
