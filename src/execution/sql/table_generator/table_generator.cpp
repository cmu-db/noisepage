...
void TableGenerator::FillTable(terrier::catalog::SqlTableHelper *catalog_table,
...
void TableGenerator::InitTestIndexes() {
  ...
  static const std::vector<IndexInsertMeta> index_metas = {
      ...
      {"index_empty", "empty_table",
       {{terrier::type::TypeId::INTEGER, false, 0}}},
      ...
      // Table 2
      {"index_2", "test_2",
       {{terrier::type::TypeId::INTEGER, true, 1},
        {terrier::type::TypeId::SMALLINT, false, 0}}}
  };
