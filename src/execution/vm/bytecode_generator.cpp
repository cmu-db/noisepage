...
void BytecodeGenerator::VisitBuiltinStorageInterfaceCall(ast::CallExpr *call, ast::Builtin builtin) {
  ...
  switch (builtin) {
    ...
    case ast::Builtin::DeleteCascade: {
      LocalVar cond = GetExecutionResult()->GetOrCreateDestination(ast::BuiltinType::Get(ctx, ast::BuiltinType::Bool));
      LocalVar tuple_slot = VisitExpressionForRValue(call->Arguments()[1]);
      GetEmitter()->Emit(Bytecode::StorageInterfaceDeleteCascade, cond, storage_interface, tuple_slot);
      GetExecutionResult()->SetDestination(cond.ValueOf());
      break;
    }
    case ast::Builtin::UpdateCascade: {
      LocalVar cond = GetExecutionResult()->GetOrCreateDestination(ast::BuiltinType::Get(ctx, ast::BuiltinType::Bool));
      LocalVar tuple_slot = VisitExpressionForRValue(call->Arguments()[1]);
      GetEmitter()->Emit(Bytecode::StorageInterfaceUpdateCascade, cond, storage_interface, tuple_slot);
      GetExecutionResult()->SetDestination(cond.ValueOf());
      break;
    }
    case ast::Builtin::UpdateVerify: {
      LocalVar cond = GetExecutionResult()->GetOrCreateDestination(ast::BuiltinType::Get(ctx, ast::BuiltinType::Bool));
      LocalVar tuple_slot = VisitExpressionForRValue(call->Arguments()[1]);
      GetEmitter()->Emit(Bytecode::StorageInterfaceUpdateVerify, cond, storage_interface, tuple_slot);
      GetExecutionResult()->SetDestination(cond.ValueOf());
      break;
    }
