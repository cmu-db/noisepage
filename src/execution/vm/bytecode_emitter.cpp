...
void BytecodeEmitter::EmitStorageInterfaceIndexCreate(Bytecode bytecode, LocalVar out, LocalVar storage_interface,
                                                     uint32_t index_oid) {
  EmitAll(bytecode, out, storage_interface, index_oid);
}
}  // namespace terrier::execution::vm
