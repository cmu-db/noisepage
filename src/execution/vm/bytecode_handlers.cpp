...
void OpStorageInterfaceIndexInsertBulk(bool *result, terrier::execution::sql::StorageInterface *storage_interface, uint32_t index_oid, terrier::storage::TupleSlot *tuple_slot) {
