...
IndexCatalogTable DatabaseCatalogTable::GetIndexTable(terrier::transaction::TransactionContext *txn,
                                                      terrier::catalog::db_oid_t oid) {
  return IndexCatalogTable(catalog_, catalog_->GetCatalogTable(oid, CatalogTableType::INDEX));
}
