...
DatabaseCatalog *Builder::CreateDatabaseCatalog(
  ...
  dbc->pg_attribute_.columns_ = new storage::SqlTable(block_store, Builder::GetColumnTableSchema());
