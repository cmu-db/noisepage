...
# String prefixed to VM execution tests
VM_TARGET_STRING = "VM main() returned: "

# String prefixed to ADAPTIVE execution tests  
ADAPTIVE_TARGET_STRING = "ADAPTIVE main() returned: "

# String prefixed to JIT execution tests
JIT_TARGET_STRING = "JIT main() returned: "

# Collection of all target strings
...
def main():
    ...
    return check(args.tpl_bin, args.tpl_folder, args.tpl_tests_file, args.build_dir)
