            ...
            parallel {
                ...
                stage('ubuntu-20.04/gcc-9.3 (Debug/ASAN/jumbotests)') {
                    ...
                    steps {
                        ...
                        sh script: 'cd build && timeout 20m python3 ../script/testing/junit/run_junit.py --build-type=debug --query-mode=simple --server-args="--pipeline_metrics_enable=True --pipeline_metrics_interval=0 --counters_enable=True --query_trace_metrics_enable=True"', label: 'UnitTest (Simple with pipeline metrics, counters, and query trace metrics)'
