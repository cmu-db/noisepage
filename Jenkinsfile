    ...
    stages {
            ...
            parallel {
                stage('macos-10.14/clang-8.0 (Debug/ASAN/jumbotests)') {
                    ...
                    steps {
                        ...
                        sh 'mkdir build'
                        sh 'cd build && cmake -GNinja -DCMAKE_BUILD_TYPE=Debug -DNOISEPAGE_USE_ASAN=ON -DNOISEPAGE_BUILD_BENCHMARKS=OFF -DNOISEPAGE_USE_JUMBOTESTS=ON .. && ninja'
                ...
                stage('ubuntu-20.04/gcc-9.3 (Debug/ASAN/jumbotests)') {
                    ...
                    steps {
                        ...
                        sh 'mkdir build'
                        sh 'cd build && cmake -GNinja -DCMAKE_CXX_COMPILER_LAUNCHER=ccache -DCMAKE_BUILD_TYPE=Debug -DNOISEPAGE_USE_ASAN=ON -DNOISEPAGE_BUILD_BENCHMARKS=OFF -DNOISEPAGE_USE_JUMBOTESTS=ON .. && ninja'
                ...
                stage('ubuntu-20.04/gcc-9.3 (Debug/Coverage/unittest)') {
                    ...
                    steps {
                        ...
                        sh 'echo y | sudo ./script/installation/packages.sh all'
                        sh 'mkdir build'
                        sh 'cd build && cmake -GNinja -DCMAKE_CXX_COMPILER_LAUNCHER=ccache -DCMAKE_BUILD_TYPE=Debug -DNOISEPAGE_USE_ASAN=OFF -DNOISEPAGE_BUILD_BENCHMARKS=OFF -DNOISEPAGE_GENERATE_COVERAGE=ON .. && ninja'
                ...
                stage('macos-10.14/clang-8.0 (Release/jumbotests)') {
                    ...
                    steps {
                        ...
                        sh 'echo y | ./script/installation/packages.sh all'
                        sh 'mkdir build'
                        sh 'cd build && cmake -GNinja -DCMAKE_BUILD_TYPE=Release -DNOISEPAGE_USE_ASAN=OFF -DNOISEPAGE_BUILD_BENCHMARKS=OFF -DNOISEPAGE_USE_JUMBOTESTS=ON .. && ninja'
                ...
                stage('ubuntu-20.04/gcc-9.3 (Release/jumbotests)') {
                    ...
                    steps {
                        ...
                        sh 'echo y | sudo ./script/installation/packages.sh all'
                        sh 'mkdir build'
                        sh 'cd build && cmake -GNinja -DCMAKE_CXX_COMPILER_LAUNCHER=ccache -DCMAKE_BUILD_TYPE=Release -DNOISEPAGE_USE_ASAN=OFF -DNOISEPAGE_BUILD_BENCHMARKS=OFF -DNOISEPAGE_USE_JUMBOTESTS=ON .. && ninja'
                        sh 'cd build && ninja check-clang-tidy'
                        sh 'cd build && timeout 1h ninja jumbotests'
                        sh 'cd build && timeout 1h ninja check-tpl'
            ...
            parallel{
                stage('macos-10.14/clang-8.0 (Debug/e2etest/oltpbench)') {
                    ...
                    steps {
                        ...
                        sh 'echo y | ./script/installation/packages.sh all'
                        sh 'mkdir build'
                        sh 'cd build && cmake -GNinja -DCMAKE_BUILD_TYPE=Debug -DNOISEPAGE_USE_ASAN=ON .. && ninja noisepage'
                ...
                stage('ubuntu-20.04/gcc-9.3 (Debug/e2etest/oltpbench)') {
                    ...
                    steps {
                        ...
                        sh 'echo y | sudo ./script/installation/packages.sh all'
                        sh 'mkdir build'
                        sh 'cd build && cmake -GNinja -DCMAKE_CXX_COMPILER_LAUNCHER=ccache -DCMAKE_BUILD_TYPE=Debug -DNOISEPAGE_USE_ASAN=ON .. && ninja noisepage'
        ...
        stage('End-to-End Performance') {
            ...
            steps {
                ...
                sh 'echo y | sudo ./script/installation/packages.sh all'
                sh 'mkdir build'
                sh 'cd build && cmake -GNinja -DCMAKE_CXX_COMPILER_LAUNCHER=ccache -DCMAKE_BUILD_TYPE=Release -DNOISEPAGE_USE_ASAN=OFF -DNOISEPAGE_USE_JEMALLOC=ON .. && ninja noisepage'
        ...
        stage('Microbenchmark') {
            ...
            steps {
                ...
                sh 'echo y | sudo ./script/installation/packages.sh all'
                sh 'mkdir build'
                sh 'cd build && cmake -GNinja -DCMAKE_CXX_COMPILER_LAUNCHER=ccache -DCMAKE_BUILD_TYPE=Release -DNOISEPAGE_USE_ASAN=OFF -DNOISEPAGE_USE_JEMALLOC=ON -DNOISEPAGE_BUILD_TESTS=OFF .. && ninja all'
            }
            post {
                cleanup {
                    deleteDir()
