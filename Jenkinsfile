    ...
    stages {
        ...
        stage('End-to-End Performance') {
            ...
            steps {
                ...
                sh 'cd build && python3 ../script/testing/oltpbench/run_oltpbench.py --config-file=../script/testing/oltpbench/configs/end_to_end_performance/tatp.json --build-type=release' 
            }
        }
