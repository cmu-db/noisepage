...
_Q1_P1 = [(OpUnit.SEQ_SCAN, [600000, 68, 7,  600000]),
...
_Q4_P1 = [(OpUnit.SEQ_SCAN, [150000, 28, 3, 100]),
...
_Q5_P1 = [(OpUnit.SEQ_SCAN, [5, 20, 2, 5]),
...
_Q5_P7 = [(OpUnit.AGG_ITERATE, [5, 16, 2, 5]),
          (OpUnit.SORT_BUILD, [5, 8, 1, 5]),
          ]

_Q5_P8 = [(OpUnit.SORT_ITERATE, [5, 24, 2, 5]),
          ]
...
_Q7_P1 = [(OpUnit.SEQ_SCAN, [650, 20, 2, 25]),
          (OpUnit.OP_DECIMAL_COMPARE, [2550, 4, 1, 2550]),
...
_Q11_P2 = [(OpUnit.SEQ_SCAN, [25, 20, 2, 25]),
           (OpUnit.OP_DECIMAL_COMPARE, [25, 4, 1, 25]),
           (OpUnit.HASHJOIN_BUILD, [1, 4, 1, 1]),
           ]

_Q11_P3 = [(OpUnit.SEQ_SCAN, [1000, 8, 2, 1000]),
           (OpUnit.HASHJOIN_PROBE, [1000, 4, 1, 50]),
           (OpUnit.HASHJOIN_BUILD, [50, 4, 1, 50]),
           ]

_Q11_P4 = [(OpUnit.SEQ_SCAN, [80000, 16, 3, 80000]),
...
_Q11_P5 = [(OpUnit.SEQ_SCAN, [80000, 20, 4, 80000]),
           (OpUnit.HASHJOIN_PROBE, [80000, 4, 1, 4000]),
           (OpUnit.OP_DECIMAL_MULTIPLY, [4000, 4, 1, 4000]),
           (OpUnit.OP_DECIMAL_PLUS_OR_MINUS, [4000, 4, 1, 4000]),
           (OpUnit.AGG_BUILD, [4000, 4, 1, 1000]),
           ]

_Q11_P6 = [(OpUnit.AGG_ITERATE, [4000, 12, 2, 4000]),
           (OpUnit.OP_DECIMAL_MULTIPLY, [4000, 4, 1, 4000]),
           (OpUnit.OP_DECIMAL_COMPARE, [4000, 4, 1, 4000]),
           (OpUnit.SORT_BUILD, [2500, 8, 1, 2500]),
           ]

_Q11_P7 = [(OpUnit.SORT_ITERATE, [2500, 12, 2, 2500]),
           ]


_SCAN_LINEITEM_P1 = [(OpUnit.SEQ_SCAN, [600000, 80, 10, 600000]),
                     ]
