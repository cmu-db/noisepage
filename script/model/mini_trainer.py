...
if __name__ == '__main__':
    ...
    aparser.add_argument('--input_path', default='mini_runner_input_nonmixed_scan',
    ...
    aparser.add_argument('--save_path', default='trained_nonmixed_model', help='Path to save the mini models')
