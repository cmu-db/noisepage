...
set(EP_CXX_FLAGS "${CMAKE_CXX_FLAGS} -w ${CMAKE_CXX_FLAGS_${UPPERCASE_BUILD_TYPE}}")
set(EP_C_FLAGS "${CMAKE_C_FLAGS} -w ${CMAKE_C_FLAGS_${UPPERCASE_BUILD_TYPE}}")
...
if (TERRIER_BUILD_TESTS OR TERRIER_BUILD_BENCHMARKS)
    ...
    if ("$ENV{GTEST_HOME}" STREQUAL "")
        if (APPLE)
            set(GTEST_CMAKE_CXX_FLAGS "-fPIC -DGTEST_USE_OWN_TR1_TUPLE=1 -Wno-unused-value -Wno-ignored-attributes -fvisibility=hidden")
        else ()
...
if (TERRIER_BUILD_BENCHMARKS)
    ...
    if ("$ENV{GBENCHMARK_HOME}" STREQUAL "")
        ...
        if (APPLE)
            set(GBENCHMARK_CMAKE_CXX_FLAGS "${GBENCHMARK_CMAKE_CXX_FLAGS} -stdlib=libc++ -fvisibility=hidden")
        endif ()
...
include_directories(SYSTEM ${LIBEV_INCLUDE_DIRS})
list(APPEND TERRIER_LINK_LIBS ${LIBEV_LIBRARIES})
