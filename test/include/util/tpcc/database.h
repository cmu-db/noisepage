...
class Database {
 ...
 private:
  ...
  Database(catalog::Schema item_schema, catalog::Schema warehouse_schema, catalog::Schema stock_schema,
           ...
           catalog::IndexSchema item_primary_index_schema,
           catalog::IndexSchema warehouse_primary_index_schema,
           catalog::IndexSchema stock_primary_index_schema,
           catalog::IndexSchema district_primary_index_schema,
           catalog::IndexSchema customer_primary_index_schema,
           catalog::IndexSchema customer_secondary_index_schema,
           catalog::IndexSchema new_order_primary_index_schema,
           catalog::IndexSchema order_primary_index_schema,
           catalog::IndexSchema order_secondary_index_schema,
           catalog::IndexSchema order_line_primary_index_schema,
