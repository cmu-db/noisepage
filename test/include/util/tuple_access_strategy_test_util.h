...
struct TupleAccessStrategyTestUtil {
  ...
  static void InsertTuple(FakeRawTuple &tuple, const storage::TupleAccessStrategy &tested, const storage::BlockLayout &layout,
  ...
  static void CheckTupleEqual(FakeRawTuple &expected,
