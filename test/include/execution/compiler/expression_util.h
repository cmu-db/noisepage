 ...
 */
  static Expression CVE(catalog::col_oid_t column_oid, type::TypeId type) {
    return std::make_shared<parser::ColumnValueExpression>(catalog::db_oid_t(0), catalog::table_oid_t(0), column_oid, type);
  }
 ...
 */
  static Expression Operator(parser::ExpressionType op_type, type::TypeId ret_type, Expression child1, Expression child2) {
 ...
 */
  static AggExpression AggCountStar() {
    return AggregateTerm(parser::ExpressionType::AGGREGATE_COUNT, Constant(1));
  }
};
}