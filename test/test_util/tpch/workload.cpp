...
Workload::Workload(common::ManagedPointer<DBMain> db_main, const std::string &db_name, const std::string &table_root) {
  ...
  accessor_ = catalog_->GetAccessor(common::ManagedPointer<transaction::TransactionContext>(txn), db_oid_, DISABLED);
...
void Workload::MakeExecutableQ1() {
  ...
  auto exec_query =
      execution::compiler::CompilationContext::Compile(*q1_last_op_.get(), exec_settings_, accessor_.get());
...
void Workload::MakeExecutableQ4() {
  ...
  auto exec_query =
      execution::compiler::CompilationContext::Compile(*q4_last_op_.get(), exec_settings_, accessor_.get());
...
void Workload::MakeExecutableQ5() {
  ...
  auto exec_query =
      execution::compiler::CompilationContext::Compile(*q5_last_op_.get(), exec_settings_, accessor_.get());
...
void Workload::MakeExecutableQ6() {
  ...
  auto exec_query =
      execution::compiler::CompilationContext::Compile(*q6_last_op_.get(), exec_settings_, accessor_.get());
...
void Workload::MakeExecutableQ7() {
  ...
  auto exec_query =
      execution::compiler::CompilationContext::Compile(*q7_last_op_.get(), exec_settings_, accessor_.get());
...
void Workload::MakeExecutableQ11() {
  ...
  auto exec_query =
      execution::compiler::CompilationContext::Compile(*q11_last_op_.get(), exec_settings_, accessor_.get());
...
void Workload::MakeExecutableQ18() {
  ...
  auto exec_query =
      execution::compiler::CompilationContext::Compile(*q18_last_op_.get(), exec_settings_, accessor_.get());
