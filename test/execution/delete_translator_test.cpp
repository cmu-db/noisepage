...
//
// Identification: test/execution/delete_translator_test.cpp
//
...
TEST_F(DeleteTranslatorTest, DeleteWithSimplePredicate) {
  ...
  // Setup the predicate
  auto a_gt_40 = CmpGteExpr(ColRefExpr(::terrier::type::TypeId::INTEGER, 0), ConstIntExpr(40));
...
TEST_F(DeleteTranslatorTest, DeleteWithCompositePredicate) {
  ...
  // a >= 20
  auto a_gt_20 = CmpGteExpr(ColRefExpr(::terrier::type::TypeId::INTEGER, 0), ConstIntExpr(20));

  // b = 21
  auto b_eq_21 = CmpEqExpr(ColRefExpr(::terrier::type::TypeId::INTEGER, 1), ConstIntExpr(21));
