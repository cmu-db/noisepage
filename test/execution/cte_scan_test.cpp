...
TEST_F(CTEScanTest, CTEInitTest) {
  ...
  uint32_t cte_table_col_type[4] = {static_cast<uint32_t>(type::TypeId::BIGINT),
                                    static_cast<uint32_t>(type::TypeId::INTEGER),
                                    static_cast<uint32_t>(type::TypeId::SMALLINT),
                                    static_cast<uint32_t>(type::TypeId::VARCHAR)};
