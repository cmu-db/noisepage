...
TEST(OperatorTests, IndexScanTest) {
  ...
  Operator index_scan_01 = IndexScan::Make(catalog::db_oid_t(2), catalog::namespace_oid_t(2), catalog::table_oid_t(4),
                                           catalog::index_oid_t(3), std::vector<AnnotatedExpression>(), "table", false,
  ...
  Operator index_scan_03 = IndexScan::Make(catalog::db_oid_t(1), catalog::namespace_oid_t(2), catalog::table_oid_t(4),
                                           catalog::index_oid_t(4), std::vector<AnnotatedExpression>(), "table", false,
                                           std::vector<catalog::col_oid_t>(), std::vector<parser::ExpressionType>(),
                                           std::vector<type::TransientValue>());
  // different from index_scan_1 in table alias
  Operator index_scan_04 = IndexScan::Make(catalog::db_oid_t(1), catalog::namespace_oid_t(2), catalog::table_oid_t(4),
                                           catalog::index_oid_t(3), std::vector<AnnotatedExpression>(), "tableTable",
  ...
  Operator index_scan_05 = IndexScan::Make(catalog::db_oid_t(1), catalog::namespace_oid_t(2), catalog::table_oid_t(4),
                                           catalog::index_oid_t(3), std::vector<AnnotatedExpression>(), "table", true,
                                           std::vector<catalog::col_oid_t>(), std::vector<parser::ExpressionType>(),
                                           std::vector<type::TransientValue>());
  ...
  Operator index_scan_06 = IndexScan::Make(catalog::db_oid_t(1), catalog::namespace_oid_t(2), catalog::table_oid_t(4),
                                           catalog::index_oid_t(3), std::vector<AnnotatedExpression>(), "table", false,
