...
TEST(OperatorTests, IndexScanTest) {
  ...
  Operator index_scan_02 =
      IndexScan::Make(catalog::db_oid_t(1), catalog::namespace_oid_t(3), catalog::table_oid_t(3),
                      catalog::index_oid_t(4), std::vector<AnnotatedExpression>(), "table", false, type, {});
  ...
  Operator index_scan_03 =
      IndexScan::Make(catalog::db_oid_t(1), catalog::namespace_oid_t(2), catalog::table_oid_t(3),
                      catalog::index_oid_t(5), std::vector<AnnotatedExpression>(), "table", false, type, {});
  // different from index_scan_1 in table alias
  Operator index_scan_04 =
      IndexScan::Make(catalog::db_oid_t(1), catalog::namespace_oid_t(2), catalog::table_oid_t(3),
                      catalog::index_oid_t(4), std::vector<AnnotatedExpression>(), "tableTable", false, type, {});
  // different from index_scan_1 in 'is for update'
  Operator index_scan_05 =
      IndexScan::Make(catalog::db_oid_t(1), catalog::namespace_oid_t(2), catalog::table_oid_t(3),
                      catalog::index_oid_t(4), std::vector<AnnotatedExpression>(), "table", true, type, {});
  ...
  EXPECT_EQ(index_scan_1.As<IndexScan>()->GetIndexOID(), catalog::index_oid_t(4));
