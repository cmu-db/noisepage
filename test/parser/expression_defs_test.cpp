...
TEST(ExpressionDefsTests, ExpressionTypeToStringTest) {
  ...
  EXPECT_EQ(ExpressionTypeToString(ExpressionType::COMPARE_IN, true), "COMPARE_IN");
  ...
  EXPECT_EQ(ExpressionTypeToString(ExpressionType::COMPARE_IS_DISTINCT_FROM, true), "COMPARE_IS_DISTINCT_FROM");
  ...
  EXPECT_EQ(ExpressionTypeToString(ExpressionType::CONJUNCTION_AND, true), "CONJUNCTION_AND");
  ...
  EXPECT_EQ(ExpressionTypeToString(ExpressionType::CONJUNCTION_OR, true), "CONJUNCTION_OR");
  ...
  EXPECT_THROW(ExpressionTypeToString(ExpressionType(100)), ConversionException);
}
