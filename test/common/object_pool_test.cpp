...
TEST(ObjectPoolTests, SimpleReuseTest) {
  ...
  statistics::PerformanceCounters<ObjectPool<uint32_t>> pc;
  ObjectPool<uint32_t> tested(reuse_limit, pc);
...
TEST(ObjectPoolTests, ConcurrentCorrectnessTest) {
  ...
  statistics::PerformanceCounters<ObjectPool<ObjectPoolTestType>> pc;
  ObjectPool<ObjectPoolTestType> tested(reuse_limit, pc);
