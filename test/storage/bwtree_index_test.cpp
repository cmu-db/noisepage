...
class BwTreeIndexTests : public TerrierTest {
 ...
 protected:
  void SetUp() override {
    ...
    unique_schema_ = catalog::IndexSchema(keycols, storage::index::IndexType::BWTREE, true, true, false, true, options);
    default_schema_ =
        catalog::IndexSchema(keycols, storage::index::IndexType::BWTREE, false, false, false, true, options);
