...
//    gc_thread_->UnregisterIndexForGC(unique_index_);
...
//
///**
// * This test creates multiple worker threads that all try to insert [0,num_inserts) as tuples in the table and into
// the
// * primary key index. At completion of the workload, only num_inserts_ txns should have committed with visible
// versions
