...
namespace terrier::storage {
  ...
  protected:
    ...
    void SetUp() override {
      ...
      replica_deferred_action_manager_ = new transaction::DeferredActionManager(common::ManagedPointer(replica_timestamp_manager_));
      replica_txn_manager_ = new transaction::TransactionManager(
          common::ManagedPointer(replica_timestamp_manager_), common::ManagedPointer(replica_deferred_action_manager_), common::ManagedPointer(&buffer_pool_), true, DISABLED);
      replica_gc_ = new storage::GarbageCollector(common::ManagedPointer(replica_timestamp_manager_), common::ManagedPointer(replica_deferred_action_manager_),
                                                  common::ManagedPointer(replica_txn_manager_), DISABLED);
      replica_catalog_ = new catalog::Catalog(common::ManagedPointer(replica_txn_manager_), common::ManagedPointer(&block_store_), common::ManagedPointer(replica_gc_));
      replica_gc_thread_ = new storage::GarbageCollectorThread(common::ManagedPointer(replica_gc_), gc_period_, DISABLED);  // Enable background GC
      ...
      replica_recovery_manager_ = new RecoveryManager(common::ManagedPointer<AbstractLogProvider>(replica_log_provider_),
                                                      common::ManagedPointer(replica_catalog_), common::ManagedPointer(replica_txn_manager_),
      ...
      replica_tcop_ = new trafficcop::TrafficCop(common::ManagedPointer(replica_txn_manager_), common::ManagedPointer(replica_catalog_), common::ManagedPointer(replica_log_provider_),
      ...
      try {
        replica_server_ = new network::TerrierServer(common::ManagedPointer<network::ProtocolInterpreter::Provider>(replica_itp_protocol_provider_), common::ManagedPointer(replica_connection_handle_factory_),
                                                     common::ManagedPointer(replica_thread_registry_), replication_port_, max_connections_);
      ...
      master_deferred_action_manager_ = new transaction::DeferredActionManager(common::ManagedPointer(master_timestamp_manager_));
      master_txn_manager_ = new transaction::TransactionManager(
          common::ManagedPointer(master_timestamp_manager_), common::ManagedPointer(master_deferred_action_manager_), common::ManagedPointer(&buffer_pool_), true, common::ManagedPointer(master_log_manager_));
      master_gc_ = new storage::GarbageCollector(common::ManagedPointer(master_timestamp_manager_), common::ManagedPointer(master_deferred_action_manager_),
